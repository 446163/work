...
The first point about be lawful and using the information fairly basically means that the information that the company collects about you should not be used for criminal purposes. The second point means that the information should only be used for what the user has agreed their information to be used for  
