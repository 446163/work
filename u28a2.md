...
In this assignment i will be going through the creation of a website along with how certain oarts of it will work to gether with the usre and why these desicionas have been made. I iwll go through th initial design with sketches, the resulting webiste, the tools used, improvments that can be made and mshow that the websitre meets the ysers requirements. 
