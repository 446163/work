...
For my website there are a few assets that are used but not many, below you will see all the images that I used throughout the creation of the website:


![image](style/background.png)
![image](style/bullet.png)
![image](style/graphic.png)
![image](style/link.png)
![image](style/search.png)
![image](style/transparent_light.png)
![image](style/transparent.png)

### Colour scheme

The colour scheme that i used for my site was very simple and related to teh content as it was a lightish green and white. I choose these as the green woudl represent the natural and "green" nature of the Lake District and so it would fit right in. I also choose white to be the other color so that the website would look more proffesional and clean, you will aldo notice that th ewhite is not pure white but has trhe pattern of a paint canvas tomake the website less bland looking. 

### Story board

To start off with, before I started the creation of the website I first thought about the colour scheme that ythe website should generally have so that i could start off somewhere. After i had selected the green and white colous i then started to look for the design of the website, I thought that it should be very mim nimal and simple so that it wa easy to use yet staill looked modern. this led to the design taht you see now on the websitewith the logo and navigation bar and so on. After this I then started to add in the pages one by one in order to get the content on the site, and this was simple as I got the information from online. Finally, I started with polishing it all up and that was uneventful.  

### outline of content

The website has 5 pgaes, home (which tells you a bit about the website and a few facts), THings to do (which tells you what there is to do at the lake district), Map (so that you can find your way to and around the lake district), History (tells you about the history of the lake district) and finally Frequently asked questions (Tells the answers to common questions so that people can find the answers).
...
The main improvement that was suggested for the website was the addition of a search function and the inclusion of more information on the screen.

"What can I improve on the website: you should add more information on the screen as well as an ability to search the site"

The solution for this was to add in a sidebar to the website so that I could display information as well as add in the search function. The code required for this is very small and only needs to look like this:
