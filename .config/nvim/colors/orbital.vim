...
if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=black ctermfg=75 cterm=NONE guibg=#000000 guifg=#5fafff gui=NONE
    set background=dark
    ...
    hi SpellBad ctermbg=bg ctermfg=20 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE guisp=#0000d7
    hi SpellCap ctermbg=bg ctermfg=223 cterm=NONE guibg=NONE guifg=#ffd7af gui=NONE guisp=#ffd7af
    hi SpellLocal ctermbg=bg ctermfg=20 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE guisp=#0000d7
    hi SpellRare ctermbg=bg ctermfg=25 cterm=NONE guibg=NONE guifg=#005faf gui=NONE guisp=#005faf
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Special ctermbg=bg ctermfg=yellow cterm=NONE
    ...
    hi SpellBad ctermbg=bg ctermfg=darkblue cterm=NONE
    hi SpellCap ctermbg=bg ctermfg=white cterm=NONE
    hi SpellLocal ctermbg=bg ctermfg=darkblue cterm=NONE
    hi SpellRare ctermbg=bg ctermfg=darkblue cterm=NONE
    ...
    hi javaScriptFunctionKey ctermbg=grey ctermfg=yellow cterm=NONE
